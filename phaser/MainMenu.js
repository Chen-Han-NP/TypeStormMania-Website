...
class MainMenu extends Phaser.Scene {
    ...
    create(){
        ...
        const startButton = this.add.text(400, 600, 'Start Game', { fontSize: 30, fill: 'white' });
        ...
        const leaderBoardButton = this.add.text(400, 700, 'LeaderBoard', {fontSize: 30, fill: 'white' });
